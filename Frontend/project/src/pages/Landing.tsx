      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <main className="flex-grow flex flex-col items-center justify-center px-4 space-y-8">
          ...
          <div className="w-full max-w-4xl mt-8 text-center">
            <button
              onClick={() => navigate('/auth?mode=signup&user=busoperator')}
              className="mt-2 px-6 py-3 rounded-md bg-blue-500 text-white hover:bg-blue-600 transition duration-200"
            >
              Sign Up as Bus Operator
            </button>
          </div>

          {/* Guesthouse Owner Section */}
          <div className="w-full max-w-4xl mt-8 text-center">
            <button
              onClick={() =>
                navigate('/auth?mode=signup&user=guesthouseowner')
              }
              className="mt-2 px-6 py-3 rounded-md bg-blue-500 text-white hover:bg-blue-600 transition duration-200"
            >
              Sign Up as Guesthouse Owner
            </button>
          </div>
        </main>
